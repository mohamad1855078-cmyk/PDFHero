...
import observabilityMiddleware, { initSentryHook } from "./middleware/observability";

// observability middleware: request-id, structured logging and optional Sentry hook
